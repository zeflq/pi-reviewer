...
`);
    ...
    it("prints success and next-step instructions after generation", async () => {
        ...
        expect(logSpy).toHaveBeenCalledWith("Next step: add your project conventions to AGENTS.md at the root of your project.");
        expect(logSpy).toHaveBeenCalledWith("This file will be used by the reviewer to understand your project's rules and patterns.");
    });
});
